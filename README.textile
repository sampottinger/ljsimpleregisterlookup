...
LabJack MODBUS Map Markup provides automatic enumeration of names and registers in LabJack's JSON MODBUS map. While a formal spec is at http://jsfiddle.net/Q2F4V/embedded/result/, LJMMM fields interprets both special fields in register names as well as data types for the automatic enumeration of addresses. The existing "JSON MODBUS map":https://bitbucket.org/labjack/ljm_constants/src/5b43af77eb9273cb4f75af9d2be6c9f858f22c56/LabJack/LJM/ljm_constants.json?at=master already uses LJMMM extensively.
